...
def build_cnn_model(input_shape):
    model = Sequential([
        ...
        Conv2D(256, (3, 3), activation='swish', padding='same', input_shape=input_shape),
        BatchNormalization(),
        MaxPooling2D((2, 2)),
        Dropout(0.3),
        ...
        Flatten(),
        Dense(256, activation='swish', kernel_regularizer=tf.keras.regularizers.l2(0.9)),
        BatchNormalization(),
        Dropout(0.1),
        Dense(128, activation='swish', kernel_regularizer=tf.keras.regularizers.l2(0.9)),
        BatchNormalization(),
        Dropout(0.1),
