...
def build_cnn_model(input_shape):
    model = Sequential([
        # First convolutional block with reduced complexity
    ...
    # Compile the model with a more conservative learning rate
    model.compile(
...
# Add learning rate scheduler with a gentler decay
...
# Set up callbacks for training with increased patience
callbacks = [
